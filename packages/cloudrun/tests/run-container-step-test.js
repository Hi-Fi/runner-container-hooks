...
jest.useRealTimers();
var testHelper;
var runContainerStepData;
describe('Run container step', function () {
    ...
    it('should not throw', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, hooks_1.runContainerStep)(runContainerStepData.args)];
                case 1:
                    exitCode = _a.sent();
                ...
                case 0:
                    extension = {
                        ...
                        spec: {
                            containers: [
                                {
                                    name: constants_1.JOB_CONTAINER_EXTENSION_NAME,
                                    command: ['sh'],
                                    args: ['-c', 'echo test']
                                },
                                {
                    ...
                    filePath = testHelper.createFile();
    ...
    it('should shold have env variables available', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
