...
import { EXTERNALS_VOLUME_NAME, POD_VOLUME_NAME } from './index'
import * as shlex from 'shlex'
import { VolumeMount } from '@azure/arm-appcontainers'
...
export function containerVolumes(
  ...
  mounts.push(
    {
      volumeName: EXTERNALS_VOLUME_NAME,
      mountPath: '/__e',
    },
    {
      volumeName: POD_VOLUME_NAME,
